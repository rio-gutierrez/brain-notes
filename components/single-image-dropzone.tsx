...
const variants = {
  base: `relative rounded-md flex justify-center items-center flex-col cursor-pointer
         min-h-[150px] min-w-[200px] border border-dashed border-gray-400 dark:border-gray-300
...
>(({ className, ...props }, ref) => {
  return (
    <button
      className={twMerge(
        // base
        `focus-visible:ring-ring inline-flex cursor-pointer items-center justify-center
